Short answer: it’s absolutely doable—and not a nightmare—if you isolate each worktree’s stack. The trick is to make the _project name, ports, hostnames, DB, and volumes_ unique per worktree. Two good paths:
